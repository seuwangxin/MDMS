...
The package "markerselection" enables users to apply the Manhattan Distance-based Marker Selection (MDMS) method. It is implemented in both R and Python. More information could be found in the user manual.
